...
<Note title="Implicação Diátaxis">

Esta página é *explanation*: ela organiza o modelo mental da topologia. Quando existir um *how-to* de inventário E/E ou um *tutorial* de modelagem de três segmentos, eles vão linkar daqui — sem misturar tipos na mesma página.
