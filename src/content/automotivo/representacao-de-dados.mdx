...
<Tip title="Vetor dourado antes de generalizar">

Antes de escrever um decoder genérico, fixe 3–5 payloads hex com valor físico esperado. Se o teste não existe, a “correção” de endianness é só opinião.
